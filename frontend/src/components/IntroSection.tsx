      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="intro-reveal">
            ...
            <Link href="/tentang-kami" className="inline-flex items-center gap-2 text-[#A42A28] font-sans text-sm font-medium mt-6 hover:gap-3 transition-all">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="intro-reveal bg-[#F7F7F7] p-6 border border-[#E5E5E5]">
                <p className="font-serif text-3xl font-bold text-[#A42A28] mb-1">{stat.number}</p>
